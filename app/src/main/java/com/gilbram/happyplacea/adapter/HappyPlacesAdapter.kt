package com.gilbram.happyplacea.adapter
...
import com.gilbram.happyplacea.activity.AddHappyPlaceActivity
import com.gilbram.happyplacea.activity.MainActivity
...
open class HappyPlacesAdapter (
    ...
    fun removeAt(position: Int) {
        val dbHanler = DatabaseHandler(context)
        val isDelete = dbHanler.deleteHappyPlace(list[position])
        if (isDelete > 0){
