package com.gilbram.happyplacea.database
...
class DatabaseHandler(context: Context) :
    ...
    fun deleteHappyPlace(happyPlace: HappyPlaceModel): Int{ val db = this.writableDatabase
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    happyPlaceList.add(place) } while (cursor.moveToNext())
            }
            cursor.close()
